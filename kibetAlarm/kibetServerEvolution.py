...
class batRoomPlay():
    ...
    def bet(self):
        ...
        msg = {"args": {"gameId": self.gameId, "action": {"type": "PLACE", "value": {"46": 160}}, "timestamp": tt(),
                        "betTags": {"openMwTables": 1, "mwLayout": 8, "latency": 279, "videoProtocol": "flvjs", "btTableView": "view2", "btVideoQuality": "gen1_ss_low", "btMiniGame": 0, "appVersion": 4, "orientation": "landscape"}},
               "id": "byhxs4zoz8",
