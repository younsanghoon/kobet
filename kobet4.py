        ...
        for s in range(10):
            ...
            if data["type"] == "lobby.rouletteNumbersUpdated":
                ...
                if data['args']["tableId"]  == '7x0b1tgh7agmf6hv':
                    r1data = data
                    print ('이머징 룰렛')
                    for i in len(r1data['args']['numbers']['results']):
                        nm1 = int(r1data['args']['numbers']['results'][i][0]['number'])
                    #data['args']['numbers']
                elif data['args']["tableId"] == 'LightningTable01':
                    r2data = data
                    print ('라이트링 룰렛')
                    for i in len(r1data['args']['numbers']['results']):
                        nm2 = int(r1data['args']['numbers']['results'][i][0]['number'])
                elif data['args']["tableId"] == 'vctlz20yfnmp1ylr':
                    r3data = data
                    print ('룰렛')
                    for i in len(r1data['args']['numbers']['results']):
                        nm3 = int(r1data['args']['numbers']['results'][i][0]['number'])
