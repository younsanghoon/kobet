...
def op(nm,nma,nmaa,x):
    for i in range(len(data['args']['numbers']['results'])):
        ...
        if nma == 0 and nmaa == 12:
            ...
            qqq = nm.reverse()
            for poi in len(qqq):
                if 18 >= qqq[poi] and 1 <= qqq :
                    Cdouns += 1
                    Cups = 0
                elif 19 <= qqq[poi] and 36 >= qqq:
                    Cdouns = 0
                    Cups +=1
            for poi1 in len(qqq):
                if Nber2 in qqq[poi1]:
                    Nber2s +=1
                    Nber1s = 0
                else:
                    Nber2s = 0
                ...
                if x == '7x0b1tgh7agmf6hv':
                    ...
                    for i in range(len(data['args']['numbers']['results'])):
                        ...
                        if nma1 == 0 and nmaa1 == 12:
                            ...
                            nm2 = nm1
                            nm2.reverse()
                            if 18 >= nm2[i] and 1 <= nm2[i] :
                                if i < 12 :
                                    Cdouns += 1
                                    Cups = 0
                                    print ('a', Cdouns, 'Cdouns', Cups,'Cups')
                            elif 19 <= nm2[i] and 36 >= nm2[i]:
                                if i < 12 :
                                    Cdouns = 0
                                    Cups +=1
                                    print ('a1', Cdouns, 'Cdouns', Cups,'Cups')
                            elif Nber2.count(nm2[i]):
                                if i < 12 :
                                    Nber2s +=1
                                    Nber1s = 0
                                    print ('a2', Nber2s,'Nber2s', Nber1s,'Nber1s')
                            elif Nber1.count(nm2[i]):
                                if i < 12 :
                                    Nber2s = 0
                                    Nber1s +=1
                                    print ('a3', Nber2s,'Nber2s', Nber1s,'Nber1s')
                            elif Rad.count(nm2[poi2]):
                                if i < 12:
                                    Rads +=1
                                    Blacks = 0
                                    print ('a4', Rads,'Rads', Blacks,'Blacks')
                            elif Black.count(nm2[poi2]):
                                if i < 12:
                                    Rads = 0
                                    Blacks +=1
                                    print ('a5', Rads,'Rads', Blacks,'Blacks')
                        elif nma1 == 1 and i == 12:
                            print ('x')
                            if 18 >= nm1[0] and 1 <= nm1[0] :
                                Cdouns += 1
                                Cups = 0
                                print ('x1', Cdouns, 'Cdouns', Cups,'Cups')
                            elif 19 <= nm1[0] and 36 >= nm1[0]:
                                Cdouns = 0
                                Cups +=1
                                print ('x2', Cdouns, 'Cdouns', Cups,'Cups')
                            elif Nber2.count(nm1[0]):
                                Nber2s +=1
                                Nber1s = 0
                                print ('x3', Nber2s,'Nber2s', Nber1s,'Nber1s')
                            elif Nber1.count(nm1[0]):
                                Nber2s = 0
                                Nber1s +=1
                                print ('x4', Nber2s,'Nber2s', Nber1s,'Nber1s')
                            if Rad.count(nm1[0]):
                                Rads +=1
                                Blacks = 0
                                print ('x5', Rads,'Rads', Blacks,'Blacks')
                            elif Black.count(nm1[0]):
                                Rads = 0
                                Blacks +=1
                                print ('x6', Rads,'Rads', Blacks,'Blacks')
                    if Cdouns > 2 :
                        print ('다운 배팅', Cdouns)
                    elif Rads > 2:
                        print ('레드 배팅', Rads)
...
#print ('이머징 룰렛',Blacks,'bl', Rads,'ra')
