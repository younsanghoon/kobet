                    ...
                    if nmaa1 == 0:
                        ...
                        if nm == 0:
                            ...
                            if Nber1s == 4 :
                                ...
                                send({"log":{"type":"CLIENT_LOBBY_TABLE_JOIN_CLICK","latency":302,"value":{"currency":"KRW","gameType":"lobby","buildId":"Build Version: 6.20191121.111140-2c066ecb at 2019-11-21 11:33:57","device":"Desktop","typeApp":"lobby4","categoryId":"roulette","tablesCount":16,"layout":"Medium","filter":"NotAvailable","timeInLobby":36186,"tableId":"LightningTable01","tableName":"라이트닝 룰렛","channel":"PCMac","orientation":"landscape","balance":0,"userAgent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36","inGame":false}}})
                                send()
                                send()
                                send()
                                send()
