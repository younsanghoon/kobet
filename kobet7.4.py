...
with requests.session() as sess:
    ...
    result =  ws.recv()
    ws.send(json.dumps({"log":{"type":"CLIENT_GAME_LOADED","value":{"typeApp":"lobby","buildId":"6.20191121.111140-2c066ecb","userAgent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36","url":"https://livecasino.eg88play.com/mobile/#game=live-casino-custom-build-flash","currency":"KRW","gameType":"lobby","inGame":false,"channel":"PCMac","orientation":"landscape"}}}))
    ...
    result =  ws.recv()
    ws.send(json.dumps({"log":{"type":"CLIENT_BALANCE_UPDATED","value":{"currency":"KRW","balance":0,"gameType":"lobby","userAgent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36","inGame":false,"channel":"PCMac","orientation":"landscape"}}}))
    ws.send(json.dumps({"log":{"type":"CLIENT_BALANCE_UPDATED","latency":-1,"value":{"currency":"KRW","gameType":"lobby","buildId":"Build Version: 6.20191121.111140-2c066ecb at 2019-11-21 11:33:57","device":"Desktop","typeApp":"lobby4","categoryId":"top_games","timeInLobby":3240,"channel":"PCMac","orientation":"landscape","balance":0,"userAgent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36","inGame":false}}}))
    result =  ws.recv()
    result =  ws.recv()
    ...
    ws.send(json.dumps({"log":{"type":"CLIENT_LOBBY_CATEGORY_CHANGE","latency":-1,"value":{"currency":"KRW","gameType":"lobby","buildId":"Build Version: 6.20191121.111140-2c066ecb at 2019-11-21 11:33:57","device":"Desktop","typeApp":"lobby4","categoryId":"top_games","category":"roulette","previousCategory":"top_games","previousTablesCount":7,"timeInLobby":4471,"channel":"PCMac","orientation":"landscape","balance":0,"userAgent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36","inGame":false}}}))
    for i in range(6):
        result =  ws.recv()
    ws.send(json.dumps({"id":wid(),"type":"lobby.updateSubscriptions","args":{"subscribeTopics":[{"topic":"table","tables":[{"tableId":"LightningTable01"},{"tableId":"7x0b1tgh7agmf6hv"},{"tableId":"vctlz20yfnmp1ylr"},{"tableId":"r5aw9yumyaxgnd90"},{"tableId":"wzg6kdkad1oe7m5k"},{"tableId":"wzg6kdkad1oe7m5k","vtId":"979uwb2tdni7dmp4"},{"tableId":"48z5pjps3ntvqc1b"}]}],"unsubscribeTopics":[]}}))
    ws.send(json.dumps({"id":wid(),"type":"lobby.updateSubscriptions","args":{"subscribeTopics":[{"topic":"table","tables":[{"tableId":"01rb77cq1gtenhmo"},{"tableId":"f1f4rm9xgh4j3u2z"},{"tableId":"q0a470up68p2b81p"},{"tableId":"DoubleBallRou001"},{"tableId":"lkcbrbdckjxajdol"},{"tableId":"lr6t4k3lcd4qgyrk"},{"tableId":"AmericanTable001"},{"tableId":"mvrcophqscoqosd6"},{"tableId":"zosmk25g2f768o52"}]}],"unsubscribeTopics":[]}}))
                        ...
                        if nm == 0:
                            ...
                            if Nber1s == 4 :
                                ...
                                for uu in range(10):
                                    ...
                                    result =  ws.recv()
                                    data = json.loads(result)
                                    a = {"subscribe":{"channel":"table-7x0b1tgh7agmf6hv","status":"success"},"time":1574774855372}
                                    b = a.keys()
                                    c = data.keys()
                                    #{"subscribe":{"channel":"table-7x0b1tgh7agmf6hv","status":"success"},"time":1574774855372}
                                    print(result)
                                    print('aaaaaaaa')
                                    if b == c:
                                        print(result)
                                        time.sleep(200)
                                ws.send(json.dumps({"id":wid(),"type":"favouriteBets.loadBets","args":{"queryString":{"tableId":"7x0b1tgh7agmf6hv"}}}))
                                result =  ws.recv()
                                #data = json.loads(result)
                                print(result)
                                print('vvvvvvvvvv')
                                ...
                                time.sleep(0.1)
                                ws.send(json.dumps({"log":{"type":"CLIENT_VIDEO_PLAYBACK_EVENT","value":{"playbackEventData":{"timestamp":tt(),"playbackEventType":"PLAYER_ATTEMPT","data":{"playerEventHistory":"flvjs","firstVideoSessionId":"nx54o66tzywcx35y-fb52cf79925c2bbce56c6fad42b80724242579185a842f2ca669685a50dafbdde26001d203aedd48-7x0b1tgh7agmf6hv-559865"},"reason":"PLAYER_ATTEMPT"},"sessionData":{"game":"roulette","videoSessionId":"nx54o66tzywcx35y-fb52cf79925c2bbce56c6fad42b80724242579185a842f2ca669685a50dafbdde26001d203aedd48-7x0b1tgh7agmf6hv-559865"},"channel":"PCMac","orientation":"landscape"}}}))
                                time.sleep(0.1)
                                ws.send(json.dumps({"log":{"type":"CLIENT_VIDEO_V2_PLAYBACK_ATTEMPT","value":{"behaviour":{"autoPlayAllowed":true},"logic":{"currentPlayer":"flvjs"},"client":{"pointInTime":42,"videoSessionId":"nx54o66tzywcx35y-fb52cf79925c2bbce56c6fad42b80724242579185a842f2ca669685a50dafbdde26001d203aedd48-7x0b1tgh7agmf6hv-559865"},"channel":"PCMac","orientation":"landscape"}}}))
                                time.sleep(0.1)
                                ws.send(json.dumps({"log":{"type":"CLIENT_PRESSED_START_VIDEO","value":{"sessionData":{"game":"roulette","videoSessionId":"nx54o66tzywcx35y-fb52cf79925c2bbce56c6fad42b80724242579185a842f2ca669685a50dafbdde26001d203aedd48-7x0b1tgh7agmf6hv-559865"},"channel":"PCMac","pressedStart":true,"orientation":"landscape"}}}))
                                time.sleep(0.1)
                                result =  ws.recv()
                                print(result)
                                ...
                                time.sleep(0.1)
                                ws.send(json.dumps({"log":{"type":"CLIENT_VIDEO_PLAYBACK_EVENT","value":{"playbackEventData":{"timestamp":tt(),"playbackEventType":"PLAYER_STARTED","data":{"playerEventHistory":"flvjs","firstVideoSessionId":"nx54o66tzywcx35y-fb52cf79925c2bbce56c6fad42b80724242579185a842f2ca669685a50dafbdde26001d203aedd48-7x0b1tgh7agmf6hv-559865"},"reason":"PLAYER_STARTED"},"sessionData":{"game":"roulette","videoSessionId":"nx54o66tzywcx35y-fb52cf79925c2bbce56c6fad42b80724242579185a842f2ca669685a50dafbdde26001d203aedd48-7x0b1tgh7agmf6hv-559865"},"channel":"PCMac","orientation":"landscape"}}}))
                                time.sleep(0.1)
                                result =  ws.recv()
                                print(result)
                                time.sleep(0.1)
                                ...
                                ws.send(json.dumps({"log":{"type":"CLIENT_VIDEO_PLAYBACK_EVENT","value":{"playbackEventData":{"timestamp":tt(),"playbackEventType":"UPGRADE","data":{"prev":"MEDIUM","next":"HIGH","playerEventHistory":"flvjs","firstVideoSessionId":"nx54o66tzywcx35y-fb52cf79925c2bbce56c6fad42b80724242579185a842f2ca669685a50dafbdde26001d203aedd48-7x0b1tgh7agmf6hv-559865"},"reason":"SUFFICIENT_BANDWIDTH"},"sessionData":{"game":"roulette","videoSessionId":"nx54o66tzywcx35y-fb52cf79925c2bbce56c6fad42b80724242579185a842f2ca669685a50dafbdde26001d203aedd48-7x0b1tgh7agmf6hv-559865"},"channel":"PCMac","orientation":"landscape"}}}))
                                time.sleep(0.1)
                                ws.send(json.dumps({"id":wid(),"type":"metrics.ping","args":{"t":tt()}}))
                                time.sleep(0.1)
                                result =  ws.recv()
