...
class Suchroom :
    ...
    def __init__ (self):
        ...
        Accept-Language: ko-KR,ko;q=0.9,en-US;q=0.8,en;q=0.7
        '''
        self.head4 = '''Host: livecasino.eg88play.com
        Connection: keep-alive
        Upgrade-Insecure-Requests: 1
        ...
        Accept-Language: ko-KR,ko;q=0.9,en-US;q=0.8,en;q=0.7
        '''
        self.head5 = '''Accept-Encoding: gzip, deflate
        Accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3
        Connection: keep-alive
        User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.70 Safari/537.36
        Accept-Language: ko-KR,ko;q=0.9,en-US;q=0.8,en;q=0.7
        ...
        '''
        self.wshead1 = '''Accept-Encoding: gzip, deflate
        Accept-Language: ko-KR,ko;q=0.9,en-US;q=0.8,en;q=0.7
        ...
        User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.70 Safari/537.36
        '''
        self.wshead2 = '''Host: livecasino.eg88play.com
        Connection: Upgrade
        Pragma: no-cache
        Cache-Control: no-cache
        ...
        Sec-WebSocket-Extensions: permessage-deflate; client_max_window_bits
        '''
        self.data = 'GameName=&Email=can741&Password=1q2w3e4r!!'
        self.addr1 = 'https://kobet-1.com/Mobile/IsMobile?IsMobile=true'
        self.addr2 = 'https://kobet-1.com/ko/Login/Login'
        self.addr3 = 'https://kobet-1.com/LiveCasino/GetLiveCasinoUrl?url='
    ...
    def RoomIn (self,E):#E 현재 돈 ------------------------------------------------------------
        La = random.random(-200,500)
        ws.send(json.dumps({"log":{"type":"CLIENT_LOBBY_TABLE_JOIN_CLICK","latency":La,"value":{"currency":"KRW","gameType":"lobby","buildId":"Build Version: 6.20191219.84546-f3434ac8 at 2019-12-19 09:02:37","device":"Desktop","typeApp":"lobby4","categoryId":"roulette","tablesCount":17,"layout":"Medium","filter":"NotAvailable","timeInLobby":11770,"tableId":"7x0b1tgh7agmf6hv","tableName":"이머지브 룰렛","tableOrder":1,"channel":"PCMac","orientation":"landscape","balance":E,"userAgent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36","inGame":false}}}))
        ws.send(json.dumps({"log":{"type":"CLIENT_PRESSED_INGAME_LOBBY_CLOSE","latency":La,"value":{"currency":"KRW","gameType":"lobby","buildId":"Build Version: 6.20191219.84546-f3434ac8 at 2019-12-19 09:02:37","device":"Desktop","typeApp":"lobby4","categoryId":"roulette","target":"InGame Lobby","timeInLobby":11773,"channel":"PCMac","orientation":"landscape","balance":E,"userAgent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36","inGame":true}}}))
        ws.send(json.dumps({"log":{"type":"CLIENT_LOBBY_EXIT","latency":La,"value":{"currency":"KRW","gameType":"lobby","buildId":"Build Version: 6.20191219.84546-f3434ac8 at 2019-12-19 09:02:37","device":"Desktop","typeApp":"lobby4","categoryId":"roulette","timeInLobby":11775,"channel":"PCMac","orientation":"landscape","balance":E,"userAgent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.88 Safari/537.36","inGame":true}}}))
    def Proom (self,y) :
    ...
    def Beting(self,A,B,C,D,E):#블랙ex : 
        self.TTa = False
        while self.TTa == False:
            if self.x == "LightningTable01":#라이트링 룰렛 48 A = 200 C = 200 B= bet_black D = ROU_Black  E = 남은 돈
                wss.send(json.dumps({"log":{"type":"CLIENT_BET_CHIP","value":{"amount":A,"type":"%s","chips":"%s@%s","codes":{"%s":A},"balance":E,"viewType":"Immersive (Overlay, Full screen, Multi-camera View)","gameType":"roulette","appVersion":4,"maxTouchPoints":0,"currency":"KRW","chipStack":[200,1000,4000,20000,100000,400000],"defaultChip":1,"tableMinLimit":200,"tableMaxLimit":2000000,"channel":"PCMac","orientation":"landscape"}}}))%(B,C,B,D)
                ...
                wss.send(json.dumps({"log":{"type":"CLIENT_BET_CHIP","value":{"amount":A,"type":"%s","chips":"%s@%s","codes":{"%s":A},"balance":E,"viewType":"Immersive (Overlay, Full screen, Multi-camera View)","gameType":"roulette","appVersion":4,"maxTouchPoints":0,"currency":"KRW","chipStack":[1000,2000,10000,20000,1000000,2000000],"defaultChip":1,"tableMinLimit":1000,"tableMaxLimit":3000000,"channel":"PCMac","orientation":"landscape"}}}))%(B,C,B,D)
                ...
                wss.send(json.dumps({"log":{"type":"CLIENT_BET_CHIP","value":{"amount":A,"type":"%s","chips":"%s@%s","codes":{"%s":A},"balance":E,"viewType":"Immersive (Overlay, Full screen, Multi-camera View)","gameType":"roulette","appVersion":4,"maxTouchPoints":0,"currency":"KRW","chipStack":[400,800,2000,10000,20000,1000000],"defaultChip":1,"tableMinLimit":400,"tableMaxLimit":3000000,"channel":"PCMac","orientation":"landscape"}}}))%(B,C,B,D)
                ...
                wss.send(json.dumps({"log":{"type":"CLIENT_BET_CHIP","value":{"amount":A,"type":"%s","chips":"%s@%s","codes":{"%s":A},"balance":E,"viewType":"Immersive (Overlay, Full screen, Multi-camera View)","gameType":"roulette","appVersion":4,"maxTouchPoints":0,"currency":"KRW","chipStack":[1000,2000,5000,25000,100000,500000],"defaultChip":1,"tableMinLimit":1000,"tableMaxLimit":2000000,"channel":"PCMac","orientation":"landscape"}}}))%(B,C,B,D)
                ...
                wss.send(json.dumps({"log":{"type":"CLIENT_BET_CHIP","value":{"amount":A,"type":"%s","chips":"%s@%s","codes":{"%s":A},"balance":E,"viewType":"Immersive (Overlay, Full screen, Multi-camera View)","gameType":"roulette","appVersion":4,"maxTouchPoints":0,"currency":"KRW","chipStack":[800,2000,10000,20000,1000000,2000000],"defaultChip":1,"tableMinLimit":800,"tableMaxLimit":3000000,"channel":"PCMac","orientation":"landscape"}}}))%(B,C,B,D)
                ...
                wss.send(json.dumps({"log":{"type":"CLIENT_BET_CHIP","value":{"amount":A,"type":"%s","chips":"%s@%s","codes":{"%s":A},"balance":E,"viewType":"Slingshot","gameType":"roulette","appVersion":4,"maxTouchPoints":0,"currency":"KRW","chipStack":[160,1000,4000,20000,100000,400000],"defaultChip":1,"tableMinLimit":160,"tableMaxLimit":2000000,"channel":"PCMac","orientation":"landscape"}}}))%(B,C,B,D)
                ...
                wss.send(json.dumps({"log":{"type":"CLIENT_BET_CHIP","value":{"amount":A,"type":"%s","chips":"%s@%s","codes":{"%s":A},"balance":E,"viewType":"Slingshot","gameType":"roulette","appVersion":4,"maxTouchPoints":0,"currency":"KRW","chipStack":[300,1000,2000,10000,20000,1000000],"defaultChip":1,"tableMinLimit":300,"tableMaxLimit":3000000,"channel":"PCMac","orientation":"landscape"}}}))%(B,C,B,D)
                ...
                if data1["type"] == "roulette.betActionResponse":
                    self.TTa = True
            elif self.x == "f1f4rm9xgh4j3u2z" : #라 팔타지 자동 룰렛 french_bet_black
                wss.send(json.dumps({"log":{"type":"CLIENT_BET_CHIP","value":{"amount":A,"type":"french_%s","chips":"%s@french_%s","codes":{"%s50ReturnOn0":A},"balance":E,"viewType":"Slingshot","gameType":"roulette","appVersion":4,"maxTouchPoints":0,"currency":"KRW","chipStack":[160,1000,4000,20000,100000,400000],"defaultChip":1,"tableMinLimit":160,"tableMaxLimit":2000000,"channel":"PCMac","orientation":"landscape"}}}))%(B,C,B,D)
                wss.send(json.dumps({"args":{"gameId":self.gameIdS(),"action":{"type":"PLACE","value":{"162":A}},"timestamp":self.tt(),"betTags":{"mwLayout":8,"openMwTables":1,"latency":random.random(-200,500),"videoProtocol":"flvjs","btTableView":"slingshot","btVideoQuality":"spa_ss_hi","btMiniGame":0,"appVersion":4,"orientation":"landscape"}},"id":self.wid(),"type":"roulette.betAction"}))
                #wss.send(json.dumps(
                result =  wss.recv()
                data1 = json.loads(result)
                if data1["type"] == "roulette.betActionResponse":
                ...
                wss.send(json.dumps({"log":{"type":"CLIENT_BET_CHIP","value":{"amount":A,"type":"%s","chips":"%s@%s","codes":{"%s":A},"balance":E,"viewType":"Immersive (Overlay, Full screen, Multi-camera View)","gameType":"roulette","appVersion":4,"maxTouchPoints":0,"currency":"KRW","chipStack":[500,1000,2000,10000,20000,1000000],"defaultChip":2,"tableMinLimit":500,"tableMaxLimit":3000000,"channel":"PCMac","orientation":"landscape"}}}))%(B,C,B,D)
                ...
                if data1["type"] == "roulette.betActionResponse":
                    self.TTa = True
            elif self.x == "AmericanTable001":#아메리칸 룰렛 D = RoDZ_Black
                wss.send(json.dumps({"log":{"type":"CLIENT_BET_CHIP","value":{"amount":A,"type":"%s","chips":"%s@%s","codes":{"%s":A},"balance":E,"viewType":"Immersive (Overlay, Full screen, Multi-camera View)","gameType":"americanroulette","appVersion":4,"maxTouchPoints":0,"currency":"KRW","chipStack":[200,1000,2000,10000,20000,1000000],"defaultChip":2,"tableMinLimit":200,"tableMaxLimit":3000000,"channel":"PCMac","orientation":"landscape"}}}))%(B,C,B,D)
                wss.send(json.dumps({"args":{"gameId":self.gameIdS(),"action":{"type":"PLACE","value":{"408":A}},"timestamp":self.tt(),"betTags":{"mwLayout":8,"openMwTables":1,"latency":random.random(-200,500),"videoProtocol":"flvjs","btTableView":"hd1","btVideoQuality":"dzerot1_imr_hi","btMiniGame":0,"appVersion":4,"orientation":"landscape"}},"id":self.wid(),"type":"roulette.betAction"}))
                wss.send(json.dumps({"log":{"type":"CLIENT_EXITED_RFB_EDIT_MODE","value":{"channel":"PCMac","orientation":"landscape"}}}))
                result =  wss.recv()
                data1 = json.loads(result)
                if data1["type"] == "roulette.betActionResponse":
                ...
                if data1["type"] == "roulette.betActionResponse":
                    self.TTa = True
            elif self.x == "m2ghpkmua5jarg4t": #Resorts Atlantic City D = RoDZ_Black
                wss.send(json.dumps({"log":{"type":"CLIENT_BET_CHIP","value":{"amount":A,"type":"%s","chips":"%s@%s","codes":{"%s":A},"balance":E,"viewType":"Immersive (Overlay, Full screen, Multi-camera View)","gameType":"americanroulette","appVersion":4,"maxTouchPoints":0,"currency":"KRW","chipStack":[1000,2000,10000,20000,1000000,2000000],"defaultChip":1,"tableMinLimit":1000,"tableMaxLimit":3000000,"channel":"PCMac","orientation":"landscape"}}}))%(B,C,B,D)
    ...
    def Robea(self)
        with requests.session() as sess:
            self.r1 = sess.get(self.addr1, headers=pharseHeaders(self.head1), verify=False)
            if self.r1.status_code == 200:
                self.r2 = sess.post(self.addr2, verify=False, headers=pharseHeaders(self.head2), data=self.data.encode())
                if self.r2.status_code == 200:
                    self.r3 = sess.get(self.addr3, headers=pharseHeaders(self.head3), verify=False)
                    if self.r3.status_code == 200:
                        self.addr4 = json.loads(self.r3.content.decode())["Message"]
                        self.r4 = sess.get(self.addr4, headers=pharseHeaders(self.head4), verify=False)
                        self.r = browser.get(addr4, verify=False, headers=pharseHeaders(self.head4))

                        self.sessionId = str(browser.get_cookiejar()["EVOSESSIONID"])
