...
class Suchroom :
    ...
    def Robea(self)
        with requests.session() as sess:
            ...
            result =  ws.recv()
            self.dataM = json.loads(result)
            if dataM["type"] == "balanceUpdated":
                self.Money = int(self.dataM['args']['balance'])
